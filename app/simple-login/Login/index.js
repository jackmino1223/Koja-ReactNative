...
class Login extends Component {
  ...
  getLabels = () => {
    var defaultLabels = {
      rememberMe: strings.remember_me,
      userIdentification: strings.user_name,
      password: strings.password,
      forgotPassword: strings.forgot_password,
      loginFormButton: strings.sign_in_now,
      forgotPasswordFormButton: strings.send,
      back: strings.back,
      have_account: strings.have_account,
      click_here: strings.click_here,
      user_signin: strings.user_signin,
    }
    return {
      ...defaultLabels,
      ...this.props.labels
  ...
  renderLoginForm = () => {
    return (
      <LoginForm
        {...this.props}
        inputStyle={[this.props.inputStyle, DefaultStyles.input]}
        inputIconStyle={[this.props.inputIconStyle, DefaultStyles.inputIcon]}
